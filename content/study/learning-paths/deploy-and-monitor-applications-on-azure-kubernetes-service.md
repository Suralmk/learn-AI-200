...
description: >-
  ...
  applications on Azure Kubernetes Service: creating deployment manifests,
  exposing applications with Kubernetes Services, externalizing configuration
  with ConfigMaps, securing sensitive settings with Secrets, attaching
  persistent storage, and monitoring/troubleshooting application health and
  connectivity.
tags:
