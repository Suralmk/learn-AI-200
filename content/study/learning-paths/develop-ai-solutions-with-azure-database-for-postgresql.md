...
description: >-
  ...
  Database for PostgreSQL: building a data foundation with schema design, SQL
  queries, and secure Python integration via Microsoft Entra authentication;
  implementing vector search with pgvector for embeddings and RAG retrieval
  patterns; and optimizing vector search performance through tuning, indexing,
  data layout, scaling, and connection pooling.
tags:
...
modules:
  - name: Build and query with Azure Database for PostgreSQL
    ...
    description: >-
      ...
      integrate with Python applications using secure authentication.
    topics:
  ...
  - name: Implement vector search with Azure Database for PostgreSQL
    ...
    description: >-
      ...
      build semantic retrieval patterns for AI applications.
    topics:
  ...
  - name: Optimize vector search in Azure Database for PostgreSQL
    ...
    description: >-
      ...
      configure vector indexes, design efficient data layouts, scale for
      high-volume workloads, and implement connection pooling for AI
      applications.
    topics:
      ...
      - >-
        Exercise - Optimize vector search performance in Azure Database for
        PostgreSQL
---
