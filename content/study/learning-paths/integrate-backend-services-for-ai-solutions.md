...
description: >-
  ...
  that support AI solutions on Azure: using Azure Service Bus to decouple
  components and queue inference requests; building event-driven workflows with
  Azure Event Grid; and creating serverless AI backends with Azure Functions.
tags:
  - Azure Service Bus
  - Azure Event Grid
  - Azure Functions
...
modules:
  - name: Queue and process AI operations with Azure Service Bus
    ...
    description: >-
      ...
      consumers, and handle failures through dead-letter queues.
    topics:
  ...
  - name: Develop event-driven AI workflows with Azure Event Grid
    ...
    description: >-
      ...
      event subscriptions, design CloudEvents, implement delivery policies, and
  ...
  - name: Create serverless AI backends with Azure Functions
    duration: ''
    description: >-
      Create serverless AI backends with Azure Functions, including inference
      endpoints, event processors, and secure integrations with other Azure
      services.
    topics: []
---
