...
Study notes for **Implement event-driven scaling with KEDA** — part of the *Scale containers in Azure Container Apps* module in the Deploy and manage apps on Azure Container Apps learning path for AI-200 exam preparation.
