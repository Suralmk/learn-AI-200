...
Study notes for **Select compute resources for performance and cost** — part of the *Scale containers in Azure Container Apps* module in the Deploy and manage apps on Azure Container Apps learning path for AI-200 exam preparation.
