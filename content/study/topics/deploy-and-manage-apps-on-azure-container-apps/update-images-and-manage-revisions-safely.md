...
Study notes for **Update images and manage revisions safely** — part of the *Manage containers in Azure Container Apps* module in the Deploy and manage apps on Azure Container Apps learning path for AI-200 exam preparation.
