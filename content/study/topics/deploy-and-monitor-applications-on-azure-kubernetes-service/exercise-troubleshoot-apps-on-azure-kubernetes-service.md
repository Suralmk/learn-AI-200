...
moduleName: Monitor and troubleshoot applications on Azure Kubernetes Service
---
## Overview

Hands-on exercise covering **Exercise - Troubleshoot apps on Azure Kubernetes Service** as part of the *Monitor and troubleshoot applications on Azure Kubernetes Service* module in the Deploy and monitor applications on Azure Kubernetes Service learning path.
...
# Add service-specific commands for: Exercise - Troubleshoot apps on Azure Kubernetes Service
```

## Python

```python
# Example pattern for: Exercise - Troubleshoot apps on Azure Kubernetes Service
