...
Study notes for **Troubleshoot pods and services** — part of the *Monitor and troubleshoot applications on Azure Kubernetes Service* module in the Deploy and monitor applications on Azure Kubernetes Service learning path for AI-200 exam preparation.
...
# Add service-specific commands for: Troubleshoot pods and services
```

## Python

```python
# Example pattern for: Troubleshoot pods and services
