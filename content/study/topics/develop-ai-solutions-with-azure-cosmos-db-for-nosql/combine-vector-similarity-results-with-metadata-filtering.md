---
title: Combine vector similarity results with metadata filtering
...
Study notes for **Combine vector similarity results with metadata filtering** — part of the *Implement vector search on Azure Cosmos DB for NoSQL* module in the Develop AI solutions with Azure Cosmos DB for NoSQL learning path for AI-200 exam preparation.
...
# Add service-specific commands for: Combine vector similarity results with metadata filtering
```

## Python

```python
# Example pattern for: Combine vector similarity results with metadata filtering
