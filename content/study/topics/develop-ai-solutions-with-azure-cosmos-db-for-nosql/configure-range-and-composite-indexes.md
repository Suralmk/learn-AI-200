...
Study notes for **Configure range and composite indexes** — part of the *Optimize query performance for Azure Cosmos DB for NoSQL* module in the Develop AI solutions with Azure Cosmos DB for NoSQL learning path for AI-200 exam preparation.
...
# Add service-specific commands for: Configure range and composite indexes
```

## Python

```python
# Example pattern for: Configure range and composite indexes
