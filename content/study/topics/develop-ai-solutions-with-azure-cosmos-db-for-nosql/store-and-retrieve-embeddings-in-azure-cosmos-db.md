---
title: Store and retrieve embeddings in Azure Cosmos DB
...
Study notes for **Store and retrieve embeddings in Azure Cosmos DB** — part of the *Implement vector search on Azure Cosmos DB for NoSQL* module in the Develop AI solutions with Azure Cosmos DB for NoSQL learning path for AI-200 exam preparation.
...
# Add service-specific commands for: Store and retrieve embeddings in Azure Cosmos DB
```

## Python

```python
# Example pattern for: Store and retrieve embeddings in Azure Cosmos DB
