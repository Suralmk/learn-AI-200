...
moduleName: Optimize query performance for Azure Cosmos DB for NoSQL
---
## Overview

Study notes for **Tune vector indexes for embedding workloads** — part of the *Optimize query performance for Azure Cosmos DB for NoSQL* module in the Develop AI solutions with Azure Cosmos DB for NoSQL learning path for AI-200 exam preparation.
...
# Add service-specific commands for: Tune vector indexes for embedding workloads
```

## Python

```python
# Example pattern for: Tune vector indexes for embedding workloads
