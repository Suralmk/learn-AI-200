---
title: Use the change feed to trigger embedding refresh
...
Study notes for **Use the change feed to trigger embedding refresh** — part of the *Implement vector search on Azure Cosmos DB for NoSQL* module in the Develop AI solutions with Azure Cosmos DB for NoSQL learning path for AI-200 exam preparation.
...
# Add service-specific commands for: Use the change feed to trigger embedding refresh
```

## Python

```python
# Example pattern for: Use the change feed to trigger embedding refresh
