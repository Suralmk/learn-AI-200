...
moduleName: Optimize vector search in Azure Database for PostgreSQL
---
## Overview

Study notes for **Choose and configure vector indexes** — part of the *Optimize vector search in Azure Database for PostgreSQL* module in the Develop AI solutions with Azure Database for PostgreSQL learning path for AI-200 exam preparation.
...
# Add service-specific commands for: Choose and configure vector indexes
```

## Python

```python
# Example pattern for: Choose and configure vector indexes
