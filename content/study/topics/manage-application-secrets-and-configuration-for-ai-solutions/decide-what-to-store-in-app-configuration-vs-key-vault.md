...
pathSlug: manage-application-secrets-and-configuration-for-ai-solutions
moduleName: Manage application settings with Azure App Configuration
---
## Overview

Study notes for **Decide what to store in App Configuration vs Key Vault** — part of the *Manage application settings with Azure App Configuration* module in the Manage application secrets and configuration for AI solutions learning path for AI-200 exam preparation.
...
# Add service-specific commands for: Decide what to store in App Configuration vs Key Vault
```

## Python

```python
# Example pattern for: Decide what to store in App Configuration vs Key Vault
