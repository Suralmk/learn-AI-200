...
Study notes for **Add the OpenTelemetry SDK to an application** — part of the *Instrument an app with OpenTelemetry* module in the Observe and troubleshoot apps on Azure learning path for AI-200 exam preparation.
...
# Add service-specific commands for: Add the OpenTelemetry SDK to an application
```

## Python

```python
# Example pattern for: Add the OpenTelemetry SDK to an application
