...
Study notes for **Debug distributed flows with trace data** — part of the *Instrument an app with OpenTelemetry* module in the Observe and troubleshoot apps on Azure learning path for AI-200 exam preparation.
...
# Add service-specific commands for: Debug distributed flows with trace data
```

## Python

```python
# Example pattern for: Debug distributed flows with trace data
