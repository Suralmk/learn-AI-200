...
Hands-on exercise covering **Exercise - Query logs with KQL** as part of the *Analyze app telemetry with logs and metrics* module in the Observe and troubleshoot apps on Azure learning path.
...
# Add service-specific commands for: Exercise - Query logs with KQL
```

## Python

```python
# Example pattern for: Exercise - Query logs with KQL
