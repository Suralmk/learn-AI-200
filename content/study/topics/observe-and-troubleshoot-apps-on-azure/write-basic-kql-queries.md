...
Study notes for **Write basic KQL queries** — part of the *Analyze app telemetry with logs and metrics* module in the Observe and troubleshoot apps on Azure learning path for AI-200 exam preparation.
...
# Add service-specific commands for: Write basic KQL queries
```

## Python

```python
# Example pattern for: Write basic KQL queries
